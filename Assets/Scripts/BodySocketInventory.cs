...
public class BodySocketInventory : MonoBehaviour
{
    ...
    {
        bodySocket.gameObject.transform.position = new Vector3(bodySocket.gameObject.transform.position.x, _currentHMDPosition.y * bodySocket.hightRatio, bodySocket.gameObject.transform.position.z);
    }
